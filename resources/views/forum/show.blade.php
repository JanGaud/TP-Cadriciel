...
@section('content')
    ...
    <div class="container show-container">
        <div class="card m-5 show-card">
            <div class="show-img">
                <img src="/social/assets/pexels-stefan-lorentz-668137.jpg" class="card-img-top" alt="...">
            </div>
            <div class="card-body">
                <h5 class="card-title">{{ $post->title }}</h5>
                <p class="card-text">{{ $post->content }}</p>
                <p class="card-text"><small class="text-muted">{{ $post->created_at->format('F jS, Y') }}</small></p>
            </div>
        </div>
    </div>
